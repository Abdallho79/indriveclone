...
import 'package:indriveclone/core/middleware/middleware.dart';
...
List<GetPage<dynamic>>? getPages = [
  ...
  GetPage(name: AppRoute.travelview, page: () => const TravelView()),
  GetPage(name: AppRoute.frieghtview, page: () => const FreightView()),
  GetPage(name: AppRoute.historyview, page: () => const HistoryView()),
  GetPage(name: AppRoute.rideDetails, page: () => const RideDetailsView()),
  GetPage(name: AppRoute.verifyview, page: () => const VerifyView()),
  GetPage(name: AppRoute.confrimview, page: () => const ConfrimView()),
];
